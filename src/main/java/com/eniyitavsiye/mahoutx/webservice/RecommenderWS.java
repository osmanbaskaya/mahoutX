...
public class RecommenderWS {
        ...
        RecommenderBuilder builder = new RecommenderBuilder() {
            ...
            public Recommender buildRecommender(DataModel model) throws TasteException {
                ...
                if (isBasedOnItems) {
                    ...
                    try {
                        strategy = (CandidateItemsStrategy) Class.forName("org.apache.mahout.cf.taste.impl.recommender." + cs)
                                .newInstance();
    ...
    public String[] getRecommendationListPaginated(
        ...
        try {
            ...
            long[] candidateItemIds =
                    ...
                    inMemoryDataModels.get(context)).toArray();
    ...
    // builds a rec. list of size 50 and returns 10 of it randomly
    public List<Long> getItemNearestNeighborList(
        ...
        TopK<Long> topk = new TopK<Long>(50) {
            private double similarity(long i, long j) {
                try {
    ...
    public static void main(String[] args) throws Exception {
        DataModel model = new FileDataModel(new File("/home/tevfik/datasets/ml-100k/ratings2.dat"));
...
*/
         ...
         //String[] list = recommenderWS.getRecommendationListPaginated(context, 1, "", 1, 100);
         List<Long> l = recommenderWS.getItemNearestNeighborList(context,3);
